 ...
 * 请求统一支付API需要提交的数据
 */
public class UnifiederPayReqData {
...
//    private String auth_code        = "";
    ...
    /**
     * @param authCode 这个是扫码终端设备从用户手机上扫取到的支付授权号，这个号是跟用户用来支付的银行卡绑定的，有效期是1分钟    不需要
     ...
     */
    public UnifiederPayReqData(String body, String attach, String outTradeNo, int totalFee, String deviceInfo, String spBillCreateIP, String timeStart, String timeExpire, String goodsTag) {
