...
import com.tencent.service.UnifiederPayService;
...
public class WXPay {
     ...
     * @throws Exception
     */
    public static String requestUnifiederPayService(UnifiederPayReqData unifiederPayReqData) throws Exception{
        return new UnifiederPayService().request(unifiederPayReqData);
    }
