...
@Repository
public class MailSenderDaoOutSideImpl implements MailSenderDao {

    @Override
    public synchronized boolean sendTextMail(MailSenderInfo mailInfo) {
...
//            sendMailSession.setDebug(true);
     ...
     */
    @Override
    public synchronized boolean sendHtmlMail(MailSenderInfo mailInfo) {
