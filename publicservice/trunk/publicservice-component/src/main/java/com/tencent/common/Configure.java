...
public class Configure {
    ...
    // 以下是几个API的路径：
    public static String        UNIFIEDER_PAY_API   = "https://api.mch.weixin.qq.com/pay/unifiedorder";
    ...
    // 12) 获取多媒体文件
    public static String        MEDIA_API           = "http://file.api.weixin.qq.com/cgi-bin/media/get";

    // 13) 获取用户基本信息(需要关注)，也可判断是否关注
    public static String        USERINFO_API        = "https://api.weixin.qq.com/cgi-bin/user/info";
