...
<div class="row">
    <div class="col-xs-12">
        <!-- <div class="table-responsive"> -->
           <form id="myForm" action="#admin/processGroupClerk/selectClerk"  onsubmit="listFormSearch(this); return false">
        ...
        <div>
								...
								<td class="center">
										<input type="checkbox"  id="clerkId_${item.id}" name="clerkId" value="${item.id}"
										 ...
										 <c:forEach items="${guList}" var="result" varStatus="current">
										 	<c:if test="${item.id eq result.clerkId}">
										 		checked />
										 	</c:if>
										 </c:forEach>
								</td>
            ...
            <form id="myForm2" action="/admin/processGroupClerk/add.do">
...
<script type="text/javascript">
    ...
    ace.load_ajax_scripts(scripts, function () {
    	$("input[name=clerkId]").each(function(){
    		...
    		var str="<tr><td id='"+id+"'><input type='hidden' name='guList["+current+"].clerkId' value='"+id+"'/>  "+name+"</td><td>"+mobile+"</td><td style='text-align:center;'><a class='delClerk'>X</a></td></tr>";
   			if($(this).is(":checked")){
