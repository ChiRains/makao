...
<div class="row">
    <div class="col-xs-12">
        <!-- PAGE CONTENT BEGINS -->
        <form id="model-form" class="form-horizontal"  role="form" action="/admin/processForm/edit.do">
            <!-- #section:elements.form -->
			<input type="hidden" name="processId" value="${processId}">
			
			<div class="space-4"></div>
            <div class="form-group">
               	<label class="col-sm-3 control-label no-padding-right" for="mainFormId"> 主表单 </label>
                <div class="col-sm-9">
					<span class="col-sm-5 no-padding block input-icon input-icon-right mr10">
						<select class="chosen-select" id="mainFormId" name="mainFormId" data-placeholder="请选择表单">
	                		<option value="">请选择表单</option>
	                		  <c:forEach items="${formDefList}" var="item" varStatus="current">
	                		  	 <option value="${item.id}"
	                		  	 <c:if test="${item.id eq processForm.mainFormId}">
		                		  	 selected
