...
@Component
public class NotionApproveResultEvent implements FormEvent,
		ExecutorVariableCalculator {
	...
	public void doEvent(FormEventType type, EventContext context) {
		...
		Map<String, Object> map = context.getParameterMap();
		Map<String, Object> vmap = new HashMap<String, Object>(map);
		vmap.put("workitem", context.getWorkitemId());
		vmap = calculate(vmap);
		context.addReturnResult("approve", vmap.get("approve"));
	}
	...
	public Map<String, Object> calculate(Map<String, Object> map) {
		...
		resultMap.put("approve", 1);
		String workitem = (String) map.get("workitem");
		logger.info("approve " + workitem);
