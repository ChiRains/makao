...
public class TaskedController {
    ...
    @RequestMapping
    public FrontPagingView list(HttpServletRequest request, TaskedQuery query, Integer pageNum, Integer pageSize) {
        ...
        view.addObject("list", taskedHandler.toVOList(page.getData()));
        return view;
    }
