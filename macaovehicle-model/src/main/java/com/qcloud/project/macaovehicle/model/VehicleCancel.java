...
public class VehicleCancel {
	...
	public VehicleCancel(){
	
	}

	public VehicleCancel(long id,String formInstCode,long carOwnerId,long vehicleId,String ric,String plateNumber,String temporaryplate,Date recordTime,int state){
		this.id = id;		
