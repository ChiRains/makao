...
public class AdminCallMeVO {
	...
	public AdminCallMeVO(){
	
	}

	public AdminCallMeVO(long id,String project,String fromSeaman,String toSeaman,String receiveSeaman,String subject,int state,Date callDate,Date updateDate){
		this.id = id;		
