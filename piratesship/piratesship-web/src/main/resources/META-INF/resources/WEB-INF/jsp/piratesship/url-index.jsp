								                ...
								                <div class="row">	
								                    <div class="col-xs-4">
								                	 <div class="dataTables_length">
								                            <a title="URL详情" class="btn btn-sm btn-info"
								                               href="/url/list.do?keyword=">
								                            ...
								                            <a title="URL未配置索引" class="btn btn-sm btn-info"
								                               href="/url/notconfiguredIndex.do">
								                                <i class="ace-icon fa fa-undo align-bottom bigger-125"></i>
								                                URL未配置索引
								                            </a>         
								                        </div>
								                    ...
								                    <div class="col-xs-8">
								                        ...
								                        <form id="query-form" action="/url/index.do" onsubmit="listFormSearch(this); return false">
								                        	<span><font color="#ff9955">共有${total}个接口,已配置${linkTotal}个接口</font></span> 
								                    ...
								                    <tbody>
								                           <c:forEach items="${list}" var="url" varStatus="current"> 
								                            <tr>      
									                            ...
									                            <td>${url.name}</td>                            
									                            <td>									                            
									                             <a title="接口详情" class="green" 
                                       									href="/url/list.do?keyword=${url.url}">
                                        								${url.url}
                                    							</a>
									                            </td>
									                        </tr>
