...
public class RolePermissionDaoMysqlImpl implements RolePermissionDao {
    ...
    public boolean add(RolePermission rolePermission) {
        ...
        return sqlOperator.insert("com.qcloud.component.permission.dao.mysql.mapper.RolePermissionMapper.insert", rolePermission) == 1;
    }

    @Override
    public RolePermission get(Long id) {

        return sqlOperator.selectOne("com.qcloud.component.permission.dao.mysql.mapper.RolePermissionMapper.get", id);
    }

    @Override
    public boolean delete(Long id) {

        return sqlOperator.delete("com.qcloud.component.permission.dao.mysql.mapper.RolePermissionMapper.delete", id) > 0;
    }

    @Override
    public boolean update(RolePermission rolePermission) {

        return sqlOperator.update("com.qcloud.component.permission.dao.mysql.mapper.RolePermissionMapper.update", rolePermission) > 0;
    }
    ...
    public Page<RolePermission> page(int start, int count) {
        ...
        List<RolePermission> list = sqlOperator.selectList("com.qcloud.component.permission.dao.mysql.mapper.RolePermissionMapper.list4page", param);
        int total = sqlOperator.selectOne("com.qcloud.component.permission.dao.mysql.mapper.RolePermissionMapper.count4page", param);
    ...
    public List<RolePermission> list(Long roleId) {
        ...
        List<RolePermission> list = sqlOperator.selectList("com.qcloud.component.permission.dao.mysql.mapper.RolePermissionMapper.listByRole", roleId);
        return list;
    }
