...
public class ResourcesDaoMysqlImpl implements ResourcesDao {
	...
	public Page<Resources> page(int start, int count){
		...
		List<Resources> list = sqlOperator.selectList(
				"com.qcloud.component.permission.dao.mysql.mapper.ResourcesMapper.list4page",
				param);
		int total = sqlOperator.selectOne(
				"com.qcloud.component.permission.dao.mysql.mapper.ResourcesMapper.count4page",
				param);
