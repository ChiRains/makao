...
public class AccountRoleDaoMysqlImpl implements AccountRoleDao {
	...
	public boolean add(AccountRole accountRole) {
		return sqlOperator
				.insert("com.qcloud.component.permission.dao.mysql.mapper.AccountRoleMapper.insert",
						accountRole) == 1;
	}
	...
	public AccountRole get(Long id) {
		return sqlOperator
				.selectOne(
						"com.qcloud.component.permission.dao.mysql.mapper.AccountRoleMapper.get",
						id);
	}
	...
	public boolean delete(Long id) {
		return sqlOperator
				.delete("com.qcloud.component.permission.dao.mysql.mapper.AccountRoleMapper.delete",
						id) > 0;
	}
	...
	public boolean update(AccountRole accountRole) {
		return sqlOperator
				.update("com.qcloud.component.permission.dao.mysql.mapper.AccountRoleMapper.update",
						accountRole) > 0;
	}
	...
	public Page<AccountRole> page(int start, int count) {
		...
		List<AccountRole> list = sqlOperator
				.selectList(
						"com.qcloud.component.permission.dao.mysql.mapper.AccountRoleMapper.list4page",
						param);
		int total = sqlOperator
				.selectOne(
						"com.qcloud.component.permission.dao.mysql.mapper.AccountRoleMapper.count4page",
						param);
	...
	public List<AccountRole> list(Long accountId) {
		List<AccountRole> list = sqlOperator
				.selectList(
						"com.qcloud.component.permission.dao.mysql.mapper.AccountRoleMapper.listByAccount",
						accountId);
		return list;
	}
	...
	public AccountRole get(Long accountId, Long roleId) {
		...
		return sqlOperator
				.selectOne(
						"com.qcloud.component.permission.dao.mysql.mapper.AccountRoleMapper.getByAccountAndRole",
						param);
	}
}
