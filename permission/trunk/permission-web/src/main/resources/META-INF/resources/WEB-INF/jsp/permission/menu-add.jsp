...
<div class="row">
    <div class="col-xs-12">
        <!-- PAGE CONTENT BEGINS -->
        <form id="model-form1" class="form-horizontal"  role="form" action="/menu/add.do">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
					<span class="col-sm-5 no-padding block input-icon input-icon-right mr10">
						<input type="text" class="width-100" maxlength="50" id="name" name="name" placeholder="名称" value=""/>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
					<span class="col-sm-5 no-padding block input-icon input-icon-right mr10">
						<input type="text" class="width-100" maxlength="50" id="code" name="code" placeholder="编码" value=""/>
						<i class="ace-icon fa"></i>
					</span>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
					<span class="col-sm-5 no-padding block input-icon input-icon-right mr10">
						<input type="text" class="width-100" maxlength="50" id="url" name="url" placeholder="请求地址" value=""/>
						<i class="ace-icon fa"></i>
					</span>
                </div>
            </div>
					...
					<span class="col-sm-5 no-padding block input-icon input-icon-right mr10">
						<select id="catalogId" name="catalogId" class="width-100">
							<c:forEach items="${catalogList}" var="catalog" >
								<option value="${catalog.id}" <c:if test="${catalog.id==query.catalogId}"> selected </c:if> > ${catalog.name} </option>
							</c:forEach>					
						</select>
						<i class="ace-icon fa"></i>
					</span>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
					<span class="col-sm-5 no-padding block input-icon input-icon-right mr10">
						<input type="text" class="width-100" maxlength="50" id="order" name="order" placeholder="排序" value="0"/>
						<i class="ace-icon fa"></i>
					</span>
                </div>
            </div>
