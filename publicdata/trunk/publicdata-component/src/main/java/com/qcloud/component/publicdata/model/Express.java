...
public class Express {
	...
	public Express(long id,String name,String code,String desc,String logo,long sort,double firstWeight,double firstPrice,double continuedWeight,double continuedPrice,long enable){
		this.id = id;		
		this.name = name;		
		this.code = code;		
		this.desc = desc;		
