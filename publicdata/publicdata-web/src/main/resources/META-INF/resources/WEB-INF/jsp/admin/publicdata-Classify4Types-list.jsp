                    ...
                    <div class="col-xs-2">
                        <div class="dataTables_length">
                            <a title="新增" class="btn btn-sm btn-info"
                               href="#admin/classify4Types/toAdd?type=${query.type}&beanId=${beanId}">
               	    ...
               	    <div class="col-xs-10">
                        <div class="text-right">
                            <label>
                                <form id="query-form" action="#admin/classify4Types/list" onsubmit="listFormSearch(this); return false">
	                             ...
	                             <td>
	                                <div class="hidden-sm hidden-xs action-buttons">
	                                    <a title="修改基本信息" class="green" 
	                                       href="#admin/classify4Types/toEdit?id=${item.id}&beanId=${beanId}">
