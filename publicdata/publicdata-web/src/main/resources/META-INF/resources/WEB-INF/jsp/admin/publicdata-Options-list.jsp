                    ...
                    <div class="col-xs-6">
                        <div class="dataTables_length">
                            <a title="新增" class="btn btn-sm btn-info"
                               href="#admin/options/toAdd?questionId=${questionId}&questionnaireId=${questionnaireId}">
                    ...
                    <div class="col-xs-6">
                    	<div class="dataTables_length">
                        	<a title="返回" class="btn btn-sm btn-back" style="float:right;"
                                  href="#admin/question/list?questionnaireId=${questionnaireId}">
                            ...
                            <tr>            
                                ...
                                <div class="hidden-sm hidden-xs action-buttons">
                                    <a title="修改基本信息" class="green" 
                                       href="#admin/options/toEdit?id=${item.id}&queryStr=${queryStr}&questionId=${questionId}&questionnaireId=${questionnaireId}">
                                        <i class="ace-icon fa fa-pencil bigger-130"></i>
                                    </a>
                                    
                                    <a title="删除" class="red del-item-new"  
							           api-path="/admin/options/delete.do?id=${item.id}">
