...
public class AdminExpressDistrictVO {
	...
	public AdminExpressDistrictVO(){
	
	}

	public AdminExpressDistrictVO(long id,long expressId,double firstPrice,double continuedPrice,String province,String city,String district){
		this.id = id;		
