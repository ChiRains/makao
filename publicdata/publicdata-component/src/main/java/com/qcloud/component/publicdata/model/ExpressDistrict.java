...
public class ExpressDistrict {
	...
	public ExpressDistrict(){
	
	}

	public ExpressDistrict(long id,long expressId,double firstPrice,double continuedPrice,String province,String city,String district){
		this.id = id;		
