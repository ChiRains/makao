...
public class AdminVehicleLossVO {
	...
	public AdminVehicleLossVO(){
	
	}

	public AdminVehicleLossVO(long id,String formInstCode,long carOwnerId,long vehicleId,String oldRic,String newRic,Date lossTime,Date recordTime,int type){
		this.id = id;		
