...
public class AdminApprovalOutsideVO {
	...
	public AdminApprovalOutsideVO(){
	
	}

	public AdminApprovalOutsideVO(long id,String code,String ric,String driverIc,String xml,int type,int subType,Date recordTime){
		this.id = id;		
		this.code = code;		
		this.ric = ric;		
