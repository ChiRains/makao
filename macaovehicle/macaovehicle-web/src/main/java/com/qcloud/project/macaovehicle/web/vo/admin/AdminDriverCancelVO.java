...
public class AdminDriverCancelVO {
	...
	public AdminDriverCancelVO(){
	
	}

	public AdminDriverCancelVO(long id,String formInstCode,long carOwnerId,long vehicleId,long driverId,String driverName,int certificateType,String certificateNo,String plateNumber,String temporaryplate,Date recordTime,String driverIc,int state){
		this.id = id;		
