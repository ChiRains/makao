...
public class AdminOnestopCarRecordVO {
	...
	public AdminOnestopCarRecordVO(){
	
	}

	public AdminOnestopCarRecordVO(long id,String dCardid,String vCardid,Date date,String gate,int type){
		this.id = id;		
