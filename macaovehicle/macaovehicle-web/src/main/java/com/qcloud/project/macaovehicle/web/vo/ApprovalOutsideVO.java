...
public class ApprovalOutsideVO {
	...
	public ApprovalOutsideVO(){
	
	}

	public ApprovalOutsideVO(long id,String code,String ric,String driverIc,String xml,int type,int subType,Date recordTime){
		this.id = id;		
		this.code = code;		
		this.ric = ric;		
