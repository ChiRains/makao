DROP TABLE IF EXISTS `metadata_xqpolicepilot_notion_hist`;
CREATE TABLE `metadata_xqpolicepilot_notion_hist` (
	...
	PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='交警意见表-意见子表备份表';
