DROP TABLE IF EXISTS `metadata_cmcpre_notion_hist_hist`;
CREATE TABLE `metadata_cmcpre_notion_hist_hist` (
	...
	PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='管委会预审意见-意见子表备份表-备份表';
