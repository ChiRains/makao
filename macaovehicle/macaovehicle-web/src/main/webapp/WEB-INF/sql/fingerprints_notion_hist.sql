DROP TABLE IF EXISTS `metadata_fingerprints_notion_hist`;
CREATE TABLE `metadata_fingerprints_notion_hist` (
	...
	PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='录指纹-意见子表备份表';
