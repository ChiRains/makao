...
public class IllegalPoliceRecord {
    ...
    public IllegalPoliceRecord() {

    }

    public IllegalPoliceRecord(long id, String plateNumber, String tplateNumber, Date violationTime, String violationCode, String violationAddress, String violationDesc, long departmentId, Date createTime, long clerkId, long carOwnerId) {
