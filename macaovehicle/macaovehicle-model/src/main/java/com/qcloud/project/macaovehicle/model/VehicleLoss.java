...
public class VehicleLoss {
    ...
    public VehicleLoss(long id, String formInstCode, long carOwnerId, long vehicleId, String oldRic, String newRic, Date lossTime, Date recordTime, int type, String plateNumber) {
