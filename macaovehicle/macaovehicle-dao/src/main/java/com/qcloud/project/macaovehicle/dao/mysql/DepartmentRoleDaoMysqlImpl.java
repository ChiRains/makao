...
public class DepartmentRoleDaoMysqlImpl implements DepartmentRoleDao {
	...
	public Page<DepartmentRole> page(int start, int count){
		...
		List<DepartmentRole> list = sqlOperator.selectList(
				"com.qcloud.project.macaovehicle.dao.mysql.mapper.DepartmentRoleMapper.list4page",
				param);
		int total = sqlOperator.selectOne(
				"com.qcloud.project.macaovehicle.dao.mysql.mapper.DepartmentRoleMapper.count4page",
				param);
	...
	public Page<DepartmentRole> page(DepartmentRoleQuery query, int start, int count){
		...
		List<DepartmentRole> list = sqlOperator.selectList(
				"com.qcloud.project.macaovehicle.dao.mysql.mapper.DepartmentRoleMapper.list4query",
				param);
		int total = sqlOperator.selectOne(
				"com.qcloud.project.macaovehicle.dao.mysql.mapper.DepartmentRoleMapper.count4query",
				param);
		Page<DepartmentRole> page = new Page<DepartmentRole>();
		page.setCount(total);
		page.setData(list);
	...
	public List<DepartmentRole> listAll(){	
		List<DepartmentRole> list = sqlOperator.selectList(
				"com.qcloud.project.macaovehicle.dao.mysql.mapper.DepartmentRoleMapper.listAll");
		return list;
	}
}
