...
public interface DriverMapper {
	...
	@Insert("insert into `macaovehicle_driver`(`id`,`carOwnerId`,`licenseNumber`,`licenseStartTime`,`licenseImage`,`driverName`,`seconddrivername`,`driverPhone`,`driverIdCard`,`driverAddress`,`idcardValidTime`,`licenseValidTime`,`quasi`,`idcardFace`,`idcardBack`,`certificateType`,`certificateNo`,`certificateDate`,`certificateUrl`,`inchImage`,`birthday`,`secondbirthday`,`sex`,`nation`,`endorsementType`,`endorsementOrgCode`,`endorsementValidtime`,`endorsementStay`,`gotoCountry`,`comefromCountry`,`nationCode`,`endorsementCode`,`healthCard`,`healthCardImg`,`driverworkplace`,`driverIc`,`driverIcState`,`updateTime`,`state`)"
