...
public class DesUtils {
    ...
    public static void main(String[] args) {
        ...
        String key2 = "2";
        String key3 = "3";
        String data = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><root><VERSION>4.0</VERSION><I_E_FLAG>E</I_E_FLAG><CABIN><HEAD>SENNA 2||150924000000||塞那2||SENNA 2||0||0||1714000||1||1||150923||150925||海上运输(1)||高栏海关(5780)||||||||******||||||0||0||01||1||||||</HEAD><ORDER>SENNA 2||150924000000||塞那2||1||02SN801509243||SIAM GAS TRADING PTE， LTD||SUPER GAS CO.，LTD||越南(141)||珠海其他(44049)||高栏海关(5780)||150925||液化丙烷、液化丁烷||1||BU/散装(4)||0||||0||1714000||||S||||</ORDER></CABIN></root>";
        String str = DesUtils.strEnc(data, key1, key2, key3);
        System.out.println(str);
        String dec = DesUtils.strDec(str, key1, key2, key3);
     ...
     * @return
     */
    public static String sendMessage(String dataPostURL, String data, String key) {

        String message = "";
        try {
            HttpPost post = new HttpPost(dataPostURL);
            // String data = "name1=张三&name2=李四&sign=" + SignUtils.sign("test", "张三", "李四");// 需要传输的数据
            // String key = "test";
            String dataToPost = DesUtils.strEnc(data, key, null, null);// 加密后的数据内容
            StringEntity stringEntity = new StringEntity(dataToPost, "UTF-8");
    ...
    public static String sendMessage(String dataPostURL, Map<String, Object> param, String key) {

        return sendMessage(dataPostURL, mapToUrl(param), key);
    }
