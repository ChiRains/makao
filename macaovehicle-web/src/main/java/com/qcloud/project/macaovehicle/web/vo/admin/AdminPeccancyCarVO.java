...
public class AdminPeccancyCarVO {
	...
	public AdminPeccancyCarVO(){
	
	}

	public AdminPeccancyCarVO(long id,String outsidePlate,String temporaryPlate,Date time,String code,String place,String behavior,int isPublish,long creatorId,Date createTime){
		this.id = id;		
