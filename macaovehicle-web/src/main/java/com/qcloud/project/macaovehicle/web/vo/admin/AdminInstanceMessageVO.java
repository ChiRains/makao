...
public class AdminInstanceMessageVO {
	...
	public AdminInstanceMessageVO(){
	
	}

	public AdminInstanceMessageVO(long id,long formInstanceId,long messageClerkId,long clerkId,Date createTime){
		this.id = id;		
