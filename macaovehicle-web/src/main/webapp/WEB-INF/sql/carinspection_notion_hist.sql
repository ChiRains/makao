DROP TABLE IF EXISTS `metadata_carinspection_notion_hist`;
CREATE TABLE `metadata_carinspection_notion_hist` (
	...
	PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='澳门车检站验车-意见子表备份表';
