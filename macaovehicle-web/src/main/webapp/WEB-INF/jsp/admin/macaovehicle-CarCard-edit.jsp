...
<div class="row">
    <div class="col-xs-12">
        <!-- PAGE CONTENT BEGINS -->
        <form id="model-form" class="form-horizontal"  role="form" action="/admin/carCard/edit.do">
            <!-- #section:elements.form -->
			<input type="hidden" name="id" value="${carCard.id}">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
					<span class="col-sm-5 no-padding block input-icon input-icon-right mr10">
						<input type="text" class="width-100" maxlength="20" id="id" name="id" placeholder="ID" value="${carCard.id}"/>
