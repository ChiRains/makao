...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<![endif]-->
		   <style>
		      .uaTips{display:none; position:fixed;left:0;right:0;top:0;bottom:0;background-color:rgba(0,0,0,.5);z-index:999}
		      .uaCon{position:absolute; width:300px;line-height:50px;left:50%;top:50%;margin:-25px 0 0 -150px;border-radius:5px;text-align:center;background-color:#fff;}
		   		.uaCon a{display:inline-block;margin-left:10px;color:#428bca}
		   </style>
	</head>
	<body class="login-layout blur-login">
		<div id="tips" class="uaTips">
		  <p class="uaCon">请使用谷歌浏览器<a href="http://www.google.cn/chrome/browser/desktop/index.html">点击下载</a></p>
		</div>
				...
				<div class="row">
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
							<div class="center">
								<h1>
									<img width="${itemMap.width}" height="${itemMap.height}" src="${itemMap.loginLogo}">
								...
								<h4 class="light-blue" id="id-company-text">${itemMap.loginMessage}</h4>
							</div>
								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<c:if test="${LisenceLimitDate != ''}">
												<h6 class="header blue lighter bigger">													
													<font color='red'>${LisenceLimitDate}</font>
												</h5>
											</c:if>	
		...
		if (!Sys.chrome) document.getElementById("tips").style.display = "block";
